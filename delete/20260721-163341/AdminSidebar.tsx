...
export function AdminSidebar() {
  ...
  const ADMIN_LINKS = [
    ...
    {
      section: t("admin.sidebar.billing.title"),
      items: [
        {
          name: t("admin.sidebar.billing.tariffs"),
          href: "/admin/billing/tariffs",
          icon: "💳",
        },
        {
          name: t("admin.sidebar.billing.history"),
          href: "/admin/billing/history",
          icon: "📜",
        },
        {
          name: t("admin.sidebar.billing.promocodes"),
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={`
          fixed inset-y-0 left-0 z-50 w-64 bg-[#0a0a0a] border-r border-black/5 dark:border-white/5 flex flex-col text-sm
          ${!isMobile ? "relative" : ""}
        `}
      >
        {/* Brand Header */}
          ...
          <AnimatePresence>
            {showSidebarLogo && (
              ...
              >
                ...
                />
                <span className="font-semibold text-pink-500 tracking-tight text-[10px] uppercase bg-pink-500/10 px-1.5 py-0.5 rounded shrink-0">
                  Admin
                </span>
              </Link>
            )}
        ...
        {/* Navigation */}
        <div
          className={`flex-1 overflow-y-auto py-4 px-3 space-y-6 ${isSidebarOpen ? "custom-scrollbar" : "scrollbar-hide"}`}
        >
                ...
                {group.items.map((link) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={cn(
                          "text-base transition-transform duration-300 origin-center",
        ...
        <div className="p-4 border-t border-black/5 dark:border-white/5 mt-auto flex flex-col gap-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:text-slate-900 dark:text-white transition-colors px-2 py-1.5 rounded-md hover:bg-black/[0.03] dark:bg-white/5 text-sm"
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="truncate text-left">
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-gray-500 truncate uppercase tracking-wider">
                    {user.role}
                  </p>
                </div>
              </div>
