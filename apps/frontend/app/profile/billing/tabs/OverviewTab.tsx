        ...
        <div className="bg-white dark:bg-[#0a0a0a] border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-3">
                Pro Creator
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400 border border-green-200 dark:border-green-500/30">
                  Active
                </span>
              </h2>
              <p className="text-slate-500 dark:text-gray-400 text-sm mt-1">Подписка активна до 21 Июля 2026</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/5">
              ...
              <p className="text-xl font-bold text-slate-900 dark:text-white">1,240 <span className="text-sm font-normal text-slate-500">из 5,000</span></p>
            </div>
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/5">
              <p className="text-sm text-slate-500 dark:text-gray-400 mb-1">Использовано за период</p>
              <p className="text-xl font-bold text-slate-900 dark:text-white">3,760 <span className="text-sm font-normal text-slate-500">кредитов</span></p>
            </div>
          </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-gray-300 text-sm mb-6">
                Вы уверены, что хотите отменить подписку <strong>Pro Creator</strong>? 
              ...
              <div className="flex flex-col gap-3">
                <button onClick={() => setCancelModalOpen(false)} className="w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors">
