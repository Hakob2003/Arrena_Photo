...
export default function ProfilePage() {
  ...
  return !user ? (
    ...
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-10">Настройки аккаунта</h1>
      ...
      <div className="space-y-8">
        ...
        <div className="glass-card p-8 rounded-2xl flex items-center gap-6">
          ...
          <button className="px-5 py-2 glass rounded-lg hover:bg-white/10 text-sm font-medium">Редактировать</button>
        </div>
        ...
        <div className="glass-card p-8 rounded-2xl">
          ...
          <div className="mt-6 border-t border-white/10 pt-6">
            ...
            <div className="flex items-center justify-between p-4 border border-indigo-500/30 bg-indigo-500/5 rounded-xl">
              ...
              <button className="text-indigo-400 text-sm font-bold hover:text-white">Управление</button>
            </div>
          </div>
        </div>
      </div>
