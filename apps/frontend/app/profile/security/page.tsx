        ...
        <form onSubmit={handleSubmit(onPasswordSubmit)} className="space-y-4">
          ...
          <div className="flex justify-end pt-2">
            <button 
              ...
              className="px-6 py-2 bg-primary text-primary-foreground font-medium rounded-lg hover:bg-secondary transition flex items-center justify-center min-w-[140px]"
            >
      ...
      <div className="pt-10 border-t border-border">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Manage your active sessions across different devices.</p>
          </div>
          <button 
        ...
        {isLoadingSessions ? (
          ...
          <div className="space-y-3">
            {sessions.map((session, idx) => (
              <div key={session.id || idx} className="flex items-center gap-4 p-4 bg-muted border border-border rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="font-medium text-foreground truncate">{session.device || session.userAgent || 'Unknown Device'}</p>
                    {idx === 0 && (
