    ...
    <div className="p-4 sm:p-8 w-full h-full flex flex-col">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-10">
        <div>
          ...
          <p className="text-muted-foreground text-sm sm:text-base">Управление созданными промптами и шаблонами.</p>
        </div>
        <button className="w-full sm:w-auto bg-primary text-primary-foreground px-6 py-3 sm:py-2.5 rounded-full font-bold hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,255,255,0.2)]">
          + Создать
        </button>
      </div>
      ...
      <div className="flex-1 border border-border rounded-2xl bg-background/40 backdrop-blur-md p-10 flex flex-col items-center justify-center text-center">
        ...
        <Link href="/generate">
          <button className="px-6 py-3 glass rounded-xl font-bold text-indigo-400 hover:text-indigo-300 hover:bg-muted/50 transition-colors">
            Перейти в Генератор
          </button>
        </Link>
      </div>
