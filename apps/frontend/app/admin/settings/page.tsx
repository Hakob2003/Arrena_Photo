        ...
        <div className="p-6 border border-black/10 dark:border-white/10 rounded-lg bg-[#0a0a0a]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="AI Template Studio" className="w-full bg-[#fafafa] dark:bg-black border border-black/10 dark:border-white/10 rounded-md p-2 text-sm text-slate-900 dark:text-white outline-none focus:border-white/30" />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-300 block mb-1">Support Email</label>
              <input type="email" defaultValue="support@studio.ai" className="w-full bg-[#fafafa] dark:bg-black border border-black/10 dark:border-white/10 rounded-md p-2 text-sm text-slate-900 dark:text-white outline-none focus:border-white/30" />
            </div>
          </div>
        </div>
