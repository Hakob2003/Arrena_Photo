  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          <p className="text-sm text-slate-500 dark:text-gray-500 mb-1">
            ...
            columns={[
              {
                ...
                header: "План",
                render: (r) => (
                  <span className="text-xs font-mono bg-black/5 dark:bg-white/10 px-2 py-1 rounded">
                    {r.plan}
                  </span>
                ),
              },
              ...
              },
              {
                ...
                header: "Приоритет",
                render: (r) => (
                  <span className="text-slate-500 font-mono">{r.priority}</span>
                ),
              },
              {
                key: "isActive",
              ...
              },
              {
                ...
                render: (r) => (
                  <button
                    ...
                    className="text-sm text-indigo-500 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300"
                  >
                    Редактировать
                  </button>
                ),
      ...
      <AnimatePresence>
        {isModalOpen && (
          <BillingModal
            title={editingPlan ? "Редактирование тарифа" : "Новый тариф"}
            ...
            <div className="space-y-4 mt-4 text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-transparent border border-black/20 dark:border-white/20 rounded-lg p-2 text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500"
                  placeholder="Например: Pro Creator"
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={formData.queueDelay}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        queueDelay: parseInt(e.target.value) || 0,
                      })
                    }
                    className="w-full bg-transparent border border-black/20 dark:border-white/20 rounded-lg p-2 text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500"
                  />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={formData.modelsAccess}
                    onChange={(e) =>
                      setFormData({ ...formData, modelsAccess: e.target.value })
                    }
                    className="w-full bg-transparent border border-black/20 dark:border-white/20 rounded-lg p-2 text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500"
                  >
