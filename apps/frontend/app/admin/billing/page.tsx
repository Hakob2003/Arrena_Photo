    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        <div className="p-4 border border-black/10 dark:border-white/10 rounded-lg bg-[#0a0a0a]">
           ...
           <p className="text-2xl font-semibold text-slate-900 dark:text-slate-900 dark:text-white">$43,350.00</p>
        </div>
        <div className="p-4 border border-black/10 dark:border-white/10 rounded-lg bg-[#0a0a0a]">
           <p className="text-sm text-slate-400 dark:text-gray-500">Active Subscriptions</p>
           <p className="text-2xl font-semibold text-slate-900 dark:text-slate-900 dark:text-white">2,550</p>
        </div>
        <div className="p-4 border border-black/10 dark:border-white/10 rounded-lg bg-[#0a0a0a]">
      ...
      <h3 className="text-lg font-medium text-slate-900 dark:text-slate-900 dark:text-white mb-4">Subscription Tiers</h3>
      <DataTable 
        data={plans}
        columns={[
          { key: 'name', header: 'Plan Name', render: (r) => <span className="font-semibold text-slate-900 dark:text-slate-900 dark:text-white">{r.name}</span> },
          ...
          { key: 'actions', header: '', render: () => <button className="text-sm text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:text-slate-900 dark:text-white border border-black/10 dark:border-white/10 px-3 py-1 rounded">Edit</button> }
        ]}
      />
    </>
  );
