            ...
            columns={[
              {
                ...
                header: "Код",
                render: (r) => (
                  <span className="font-mono bg-black/5 dark:bg-white/10 px-2 py-0.5 rounded text-slate-900 dark:text-white font-bold">
                    {r.code}
                  </span>
                ),
              },
            ...
            <div className="space-y-4 mt-4 text-left">
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    type="text"
                    className="flex-1 bg-transparent border border-black/20 dark:border-white/20 rounded-lg p-2 text-slate-900 dark:text-white font-mono uppercase focus:outline-none focus:border-indigo-500"
                    placeholder="NEWYEAR20"
                  />
                  <button className="px-3 bg-black/5 dark:bg-white/10 rounded-lg text-sm font-medium hover:bg-black/10 dark:hover:bg-white/5">
                    Сгенерировать
                  </button>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full bg-transparent border border-black/20 dark:border-white/20 rounded-lg p-2 text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500">
                    <option className="bg-transparent text-slate-900 dark:text-white">
                      Процент (%)
                    </option>
                    <option className="bg-transparent text-slate-900 dark:text-white">
                      Фикс. сумма ($)
