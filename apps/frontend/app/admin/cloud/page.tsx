  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <button className="px-3 py-1.5 bg-white text-black text-sm font-medium rounded-md hover:bg-gray-200">
            Connect Bucket
          </button>
        }
      />
          ...
          <DataTable
            ...
            columns={[
              ...
              },
              {
                ...
                header: "",
                render: () => (
                  <button className="text-sm text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:text-slate-900 dark:text-white border border-black/10 dark:border-white/10 px-3 py-1 rounded">
                    Configure
                  </button>
                ),
              },
