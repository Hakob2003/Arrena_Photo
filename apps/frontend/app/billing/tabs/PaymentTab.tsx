    ...
    <div className="space-y-8 animate-in fade-in">
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-black/10 dark:border-white/10">
          <button
            onClick={() => toast.success("Apple Pay opening...")}
            className="flex-1 flex items-center justify-center gap-2 py-3 bg-black hover:bg-black/5 dark:bg-white dark:hover:bg-gray-200 text-white dark:text-black font-semibold rounded-xl transition-colors"
          >
          ...
          <button
            onClick={() => toast.success("Google Pay opening...")}
            className="flex-1 flex items-center justify-center gap-2 py-3 bg-white hover:bg-gray-50 text-slate-700 border border-black/20 font-semibold rounded-xl transition-colors shadow-sm"
          >
            <svg
              viewBox="0 0 488 512"
              className="w-4 h-4 fill-current text-[#4285F4]"
            >
