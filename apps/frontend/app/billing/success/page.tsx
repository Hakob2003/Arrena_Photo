...
export default function BillingSuccessPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-transparent p-4">
      ...
      >
        <div
          className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${isLuxury ? "bg-[#D4AF37]/20" : "bg-green-100 dark:bg-green-500/20"}`}
        >
          <svg
            className={`w-10 h-10 ${isLuxury ? "text-[#D4AF37]" : "text-green-600 dark:text-green-400"}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <p className="text-slate-600 dark:text-gray-400 mb-8">
          Ваш тариф успешно обновлен. Спасибо, что выбираете нас! Все новые
          функции уже доступны в вашем аккаунте.
        </p>
