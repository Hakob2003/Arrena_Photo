  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
      <div className="max-w-md w-full bg-red-900/20 border border-red-500/50 rounded-xl p-6 text-center shadow-xl">
        ...
        <p className="text-muted-foreground mb-6 font-mono text-sm break-all">{error.message || 'Неизвестная ошибка интерфейса'}</p>
        <button
          className="px-6 py-2 bg-red-600 hover:bg-red-700 text-foreground font-bold rounded-lg transition-colors"
          onClick={
