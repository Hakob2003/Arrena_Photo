...
export default function CloudConnectionsPage() {
  ...
  return (
    <div className="p-4 sm:p-8 w-full">
      ...
      <p className="text-slate-500 dark:text-gray-400 mb-10">Подключите S3-хранилище для сохранения сгенерированных изображений.</p>
      ...
      <div className="glass-card p-6 sm:p-8 rounded-2xl border-t-2 border-t-purple-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="text-xs text-slate-400 dark:text-gray-500 uppercase font-semibold mb-1 block">Bucket Name</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="text-xs text-slate-400 dark:text-gray-500 uppercase font-semibold mb-1 block">Access Key ID</label>
            <input 
              type="text" 
          ...
          <div>
            <label className="text-xs text-slate-400 dark:text-gray-500 uppercase font-semibold mb-1 block">Secret Access Key</label>
            <input 
              type="password" 
