    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="glass-card p-8 rounded-2xl border-t-2 border-t-blue-500 mb-8">
        ...
        <div className="flex justify-end">
          {driveConnected ? (
            <button onClick={disconnectDrive} className="px-6 py-2 border border-red-500/30 text-red-400 hover:bg-red-500/10 rounded-lg font-medium transition-colors">
              Отключить
            </button>
          ) : (
            <button onClick={connectDrive} className="px-6 py-2 bg-white text-black hover:bg-gray-100 rounded-lg font-bold shadow-lg transition-colors">
      ...
      <div className="glass-card p-8 rounded-2xl border-t-2 border-t-purple-500">
