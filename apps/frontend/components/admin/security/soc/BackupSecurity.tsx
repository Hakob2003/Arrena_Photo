    ...
    <BentoCard className="h-full flex flex-col" delay={0.3}>
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-sm font-semibold tracking-wide text-white uppercase">
          {t("soc.backup.title") || "Backup Security"}
        </h3>
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 gap-y-4 gap-x-2">
        ...
        <div>
          <div className="text-[10px] text-white/40 uppercase font-bold">
            {t("soc.backup.encrypted") || "Encrypted"}
          </div>
          <div className="text-sm font-medium flex items-center gap-1 text-emerald-400">
            {data.encrypted ? <CheckCircle2 className="w-4 h-4" /> : t("soc.backup.no") || "No"}
          </div>
        </div>
        <div>
          <div className="text-[10px] text-white/40 uppercase font-bold">
            {t("soc.backup.verified") || "Verified"}
          </div>
          <div className="text-sm font-medium flex items-center gap-1 text-emerald-400">
            {data.verified ? <CheckCircle2 className="w-4 h-4" /> : t("soc.backup.no") || "No"}
          </div>
        </div>
        <div className="col-span-2">
          <div className="text-[10px] text-white/40 uppercase font-bold">
            {t("soc.backup.lastTest") || "Last Restore Test"}
          </div>
