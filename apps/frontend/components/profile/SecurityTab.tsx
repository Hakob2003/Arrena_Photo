...
export default function SecurityProfilePage() {
  ...
  useEffect(() => {
    ...
    const savedItemsPerPage = localStorage.getItem("securityItemsPerPage");
          ...
          <div className="space-y-3">
            {sessions
              ...
              .map((session, idx) => (
                <div
                  key={session.id || idx}
                  className="flex items-center gap-4 p-4 bg-black/[0.03] dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {idx === 0 && (
                        <span className="px-2 py-0.5 bg-green-500/20 text-green-400 text-[10px] uppercase font-bold rounded-full">
            ...
            {sessions.length === 0 && (
              <p className="text-center text-slate-400 dark:text-gray-500 py-4">
