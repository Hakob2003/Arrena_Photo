          ...
          >
            <div className="bg-[#111] border border-black/10 dark:border-white/10 rounded-2xl w-full max-w-lg p-6 flex flex-col shadow-2xl relative overflow-hidden">
              <button 
                ...
                className="absolute top-4 right-4 z-10 p-2 bg-[#fafafa] dark:bg-black/50 hover:bg-black/[0.05] dark:bg-white/10 rounded-full text-slate-900 dark:text-white transition"
              >
                <X className="w-5 h-5" />
              </button>
