...
export default function NotificationsProfilePage() {
  ...
  const toggles = [
    ...
    },
    {
      ...
      description:
        "Get notified when your long-running AI generations are complete.",
      disabled: false,
    },
    {
    ...
    },
    {
      ...
      description:
        "Stay up to date with new models, features, and platform updates.",
      disabled: false,
    },
    {
      name: "notifySystem",
  ...
  if (isLoading) {
    return (
      <div className="animate-pulse space-y-8">
        <div className="h-40 bg-black/[0.05] dark:bg-white/10 rounded-xl"></div>
      </div>
    );
  }
            ...
            render={({ field }) => (
              <div
                className={cn(
                  ...
                  idx !== 0 &&
                    "pt-6 border-t border-black/5 dark:border-white/5",
                )}
              >
                <div className="pr-8">
                  <h3
