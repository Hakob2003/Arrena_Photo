  ...
  if (isLoading) {
    return (
      <div className="animate-pulse space-y-8">
        <div className="h-24 w-24 bg-black/[0.05] dark:bg-white/10 rounded-full" />
        <div className="h-10 bg-black/[0.05] dark:bg-white/10 rounded-lg w-1/2" />
        <div className="h-10 bg-black/[0.05] dark:bg-white/10 rounded-lg w-full" />
        <div className="h-32 bg-black/[0.05] dark:bg-white/10 rounded-lg w-full" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      >
        ...
        <div className="pt-6 border-t border-black/10 dark:border-white/10">
          <h3 className="text-sm font-medium text-gray-300 mb-4">
            {t("profile.personal.socialLinks")}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-500 dark:text-gray-400">
                {t("profile.personal.telegram")}
              </label>
              <input
                {...register("socialLinks.telegram")}
                className="w-full bg-black/[0.03] dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg px-4 py-2 text-slate-900 dark:text-slate-900 dark:text-white focus:border-white/30"
                placeholder="t.me/username"
              />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-500 dark:text-gray-400">
                {t("profile.personal.instagram")}
              </label>
              <input
