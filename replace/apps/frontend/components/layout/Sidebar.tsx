          ...
          !isMobile
            ...
            : [
                ...
                isPremium
                  ...
                  : "bg-white/95 dark:bg-[#0A0A0A]/95 backdrop-blur-xl border-r border-black/10 dark:border-white/10",
              ],
        )}
      >
        <div
        ...
        >
          {user ? (
            <div
              className={`flex items-center ${isSidebarOpen ? "justify-between w-full" : "justify-center w-full"}`}
            >
              <Link
                href="/profile"
