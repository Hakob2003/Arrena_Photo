...
export default function ProfileLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 w-full max-w-7xl mx-auto py-8 px-4 md:px-8">
      {/* Sidebar Navigation */}
      <nav className={cn(
        "flex md:flex-col gap-2 overflow-x-auto md:overflow-visible py-3 md:py-0 md:w-64 shrink-0 no-scrollbar sticky top-16 md:top-24 z-40 -mx-4 px-4 md:mx-0 md:px-0 md:h-fit md:self-start transition-all duration-300",
        isMobile && isPremium ? "bg-white/5 dark:bg-[#060606]/80 backdrop-blur-md border-b border-white/5" : "",
        isMobile && !isPremium ? "bg-white/90 dark:bg-black/90 backdrop-blur-md" : "",
