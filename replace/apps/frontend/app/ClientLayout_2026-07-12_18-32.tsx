...
export function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const handleTouchStart = (e: React.TouchEvent) => {
    ...
    setTouchStartScrollY(mainScroll ? mainScroll.scrollTop || window.scrollY : window.scrollY);
  };
    ...
    <SmoothScrollProvider>
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-w-0 relative">
          ...
          <Topbar />
          <main id="main-scroll-container" className={preferences.skin === 'PREMIUM' ? "flex-1 relative z-10 overflow-hidden" : "flex-1 relative z-10 custom-scrollbar pb-20"}>
